window.addEventListener("load", function () {
  ...
  const play = document.querySelector(".item-play");
  const duration = document.querySelector(".item-duration");
  play.addEventListener("click", function (e) {
    // song.play();
    console.log(e.target);
    // e.target.classList.remove("play-outline");
    e.target.setAttribute("name", "pause-outline");
    e.target.classList.add("pause-outline");
  });
});
